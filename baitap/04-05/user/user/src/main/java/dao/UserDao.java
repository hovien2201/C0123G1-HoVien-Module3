...
public class UserDao implements IUserDao {
    private String jdbcURL = "jdbc:mysql://localhost:3306/bai_tap_04_05?useSSL=false";
    private String jdbcUsername = "root";
    private String jdbcPassword = "hovien2201";
    ...
    @Override
    public List<User> selectUsersSearch(String countrys) {
        List<User> users = new ArrayList<>();
        try (Connection connection = getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_SEARCH_COUNTRY);) {
