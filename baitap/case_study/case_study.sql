...
SET FOREIGN_KEY_CHECKS = 0; -- tat lien ket khoa ngoai
...
DELETE FROM khach_hang WHERE ma_khach_hang IN( SELECT mkh FROM(SELECT kh.ma_khach_hang mkh FROM  khach_hang kh
INNER JOIN hop_dong hd ON kh.ma_khach_hang=hd.ma_khach_hang
WHERE  YEAR(hd.ngay_lam_hop_dong) <2021
GROUP BY kh.ma_khach_hang) AS ma_kh);
